    ...
    def parse_newhouse(self, response):
        ...
        for li in lis:
            ...
            if li.xpath('.//div[@class="clearfix"]/h3'):
                ...
                areas_text = ''.join(li.xpath('.//div[contains(@class, "house_type")]/text()').getall())
                areas = re.sub(r'\s|－|/', '', areas_text)
                ...
                item = NewHouseItem(province=province, city=city, name=name, house_type=house_type, areas=areas,
